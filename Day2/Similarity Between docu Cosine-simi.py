# Write a program to find the similarity between different documents. Using Co-sine Similarity
import math;
import pandas as pd;
import os


DOCUMENTS_PATH=[r'C:\Users\Rental\Desktop\data mining lab\Day2\Files\d1.txt',r'C:\Users\Rental\Desktop\data mining lab\Day2\Files\d2.txt',r'C:\Users\Rental\Desktop\data mining lab\Day2\Files/d3.txt',r'C:\Users\Rental\Desktop\data mining lab\Day2\Files/d4.txt',r'C:\Users\Rental\Desktop\data mining lab\Day2\Files/d5.txt']
...
for doc in range(0,len(DOCUMENTS_PATH)):
    ...
    # freq=findFrequencyOfWordInDocument("Files/d1.txt")
    for word in freq:
        if UNION_WORDS.get(word)!=None:
            UNION_WORDS[word][doc]+=freq[word];
        else:
            # Create list of [0,0,0,....len(DOCUMENTS_PATH)];
